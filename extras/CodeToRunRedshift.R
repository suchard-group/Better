...
# outputFolder <- "E:/betterGBS_OptumDod" # DONE # changed the save directory
...
# outputFolder <- "E:/betterGBS_OptumEhr" # DONE
...
# outputFolder <- "E:/betterGBS_mdcd" # DONE
...
# outputFolder <- "E:/betterGBS_ccae" # DONE
...
outputFolder <- "E:/betterGBS_mdcr" # DONE
