...
2. Probability threshold $\delta1$ --- i.e., we may change the Bayesian decision rule to attain a desired overall (Type I) error rate
...
3. Choose probability threshold $\delta1$, **with** de-biasing/adjustment

4. Choose probability threshold $\delta1$, **without** de-biasing/adjustment
