...
#### Example 1: with de-biasing/adjustment, `Historical Comparator` design
...
#### Example 2: without de-biasing/adjustment, `Historical Comparator` design
...
1. How to justify changing $h$? 

2. This whole thing is retrospective calibration --- can't really do this in practice, and it also suffers the pre-schedule problem of MaxSPRT.
