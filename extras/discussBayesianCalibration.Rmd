...
```{r HC without bias adjustment temporal, echo = FALSE, fig.width=10, fig.height=4.5,results='hide',message=FALSE,warning=FALSE}
...
```{r HC with bias adjustment temporal, echo = FALSE, fig.width=10, fig.height=4.5,results='hide',message=FALSE,warning=FALSE}
...
#### (a) Without bias adjustment
```{r SCCS without bias adjustment temporal, echo = FALSE, fig.width=10, fig.height=4.5,results='hide',message=FALSE,warning=FALSE}
...
#### (b) With bias adjustment, choosing or not choosing $\delta_1$ for desired Type I error rates
```{r SCCS with bias adjustment temporal, echo = FALSE, fig.width=10, fig.height=4.5,results='hide',message=FALSE,warning=FALSE}
