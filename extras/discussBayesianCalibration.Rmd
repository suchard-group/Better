...
#### (a) With bias adjustment, choosing or not choosing $\delta_1$ for desired Type I error rates
```{r HC with bias adjustment temporal, echo = FALSE, fig.width=10, fig.height=4.5}
...
#### (b) Without bias adjustment
```{r HC without bias adjustment temporal, echo = FALSE, fig.width=10, fig.height=4.5}
...
### SCCS design
#### (a) With bias adjustment, choosing or not choosing $\delta_1$ for desired Type I error rates
```{r SCCS with bias adjustment temporal, echo = FALSE, fig.width=10, fig.height=4.5}
...
#### (b) Without bias adjustment
```{r SCCS without bias adjustment temporal, echo = FALSE, fig.width=10, fig.height=4.5}
