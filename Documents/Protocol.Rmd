...
* Analyses: 
    1) Historic comparator/historic rates (frequentist)
    2) Historic comparator/historic rates (Bayesian)
...
We will use both the historic comparator and self-controlled designs, apply both frequentist and Bayesian sequential testing methods, and run analyses on a variety of large-scale databases, in the hope of a more comprehensive analysis of the risk of GBS post zoster vaccination. 
...
data_sources <- readr::read_delim(col_names = TRUE, delim = ";", trim_ws = TRUE, file = "
  ...
  Columbia University Health Records Database (CU); US, general; -- ; -- ; (data description pending).
")
...
- (For the historic comparator design) A log-normal prior with mean $=$ historic rate and SD $=4$ to incorporate historic information
