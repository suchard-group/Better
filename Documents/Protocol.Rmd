...
**PBR** and is an employee of Janssen Research and Development and shareholders in Johnson & Johnson.
...
dates <- readr::read_delim(col_names = TRUE, delim = ";", trim_ws = TRUE, file = "
  ...
  End of analysis; 08/31/2022
  Results presentation; 09/30/2022
")
